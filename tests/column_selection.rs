...
use kyrax::{DType, DTypes, IdxOrName, LoadSheetOrTableOptions, SelectedColumns};
...
#[fixture]
fn reader() -> kyrax::ExcelReader {
    kyrax::read_excel(path_for_fixture("sheet-with-tables.xlsx"))
        .expect("could not read excel file")
}

#[rstest]
fn test_use_columns_with_table(mut reader: kyrax::ExcelReader) -> Result<()> {
...
#[fixture]
fn reader_with_offset() -> kyrax::ExcelReader {
    kyrax::read_excel(path_for_fixture("sheet-and-table-with-offset.xlsx"))
        .expect("could not read excel file")
}

#[rstest]
fn test_use_column_range_with_offset_with_table_and_specified_dtypes(
    mut reader_with_offset: kyrax::ExcelReader,
) -> Result<()> {
    ...
    let expected_selected_columns = vec![
        kyrax::ColumnInfo {
            ...
            index: 0,
            absolute_index: 3,
            dtype: kyrax::DType::Int,
            column_name_from: kyrax::ColumnNameFrom::Provided,
            dtype_from: kyrax::DTypeFrom::ProvidedByIndex,
        },
        kyrax::ColumnInfo {
            ...
            dtype: kyrax::DType::String,
            column_name_from: kyrax::ColumnNameFrom::Provided,
            dtype_from: kyrax::DTypeFrom::ProvidedByName,
        },
    ];
