...
impl ColumnInfo {
    ...
    /// - `column_name_from`: `kyrax.ColumnNameFrom`. The origin of the column name
    /// - `dtype`: `kyrax.DType`. The dtype of the column
    /// - `dtype_from`: `kyrax.DTypeFrom`. The origin of the dtype for the column
    #[new]
    pub(crate) fn py_new(
        name: String,
        index: usize,
    ...
    /// `kyrax.DType`. The dtype of the column
    #[getter(dtype)]
    ...
    /// `kyrax.ColumnNameFrom`. How the name of the column was determined.
    ///
    ...
    /// `kyrax.DTypeFrom`. How the dtype of the column was determined.
    ///
    /// One of three possible values:
