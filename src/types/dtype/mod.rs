...
use crate::error::{KyraxError, KyraxErrorKind, KyraxResult};
...
impl FromStr for DType {
    ...
    fn from_str(raw_dtype: &str) -> KyraxResult<Self> {
        match raw_dtype {
            "null" => Ok(Self::Null),
            "int" => Ok(Self::Int),
            "float" => Ok(Self::Float),
            ...
            _ => Err(KyraxErrorKind::InvalidParameters(format!(
...
impl FromStr for DTypes {
    ...
    fn from_str(dtypes: &str) -> KyraxResult<Self> {
...
impl FromStr for DTypeCoercion {
    ...
    fn from_str(raw_dtype_coercion: &str) -> KyraxResult<Self> {
